...
const AntiRaggingPage = () => {
  const sections = [
    ...
    {
      title: "2. Institution's Anti-Ragging Policy",
      content: [
    ...
    {
      title: "3. Prohibition of Ragging",
      content: [
    ...
    {
      title: "4. Anti-Ragging Committee",
      content: [
    ...
    {
      title: "6. Duties and Responsibilities of Students",
      content: [
        "Every student shall:",
    ...
    {
      title: "8. Investigation and Inquiry Procedure",
      content: [
    ...
    {
      title: "9. Punishments and Penalties",
      content: [
    ...
    {
      title: "10. Criminal Liability for Ragging",
      content: [
    ...
    {
      title: "11. Awareness and Preventive Measures",
      content: [
    ...
    {
      title: "12. Online Registration on Anti-Ragging Portal",
      content: [
    ...
    {
      title: "13. Special Provisions for Hostel Students",
      content: [
    ...
    {
      title: "14. Role of Faculty and Staff",
      content: [
    ...
    {
      title: "15. Counseling and Support Services",
      content: [
    ...
    {
      title: "17. Annual Compliance and Reporting",
      content: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <header className="mb-16 text-center">
          <div className="inline-block mb-6">
            <div className="inline-flex items-center gap-3 px-6 py-2 bg-red-50 border-2 border-red-600 rounded-full">
              <span className="w-2 h-2 bg-red-600 rounded-full" />
              <span className="text-sm font-medium text-red-900 tracking-wider uppercase">Zero Tolerance Policy</span>
            </div>
          </div>
        ...
        <article className="max-w-4xl mx-auto">
          {/* Preamble */}
          <div className="mb-12 p-6 bg-red-50 border-l-4 border-red-600 rounded">
            <p className="text-base leading-relaxed text-gray-700 mb-3">
              <strong className="text-red-900">RAGGING IS A CRIMINAL OFFENSE.</strong> Divine Group of Institutions is committed to providing 
              a safe, secure, and respectful learning environment for all students. The institution has adopted a 
              <strong> zero-tolerance policy</strong> towards ragging in any form.
            </p>
            <p className="text-base leading-relaxed text-gray-700">
              This policy is in strict compliance with the University Grants Commission (UGC) Regulations on Curbing the 
              Menace of Ragging in Higher Educational Institutions, 2009, and subsequent amendments. Any violation will 
              result in severe disciplinary action including expulsion and legal prosecution.
            </p>
          </div>
          ...
          {/* Emergency Notice */}
          <div className="mt-12 p-6 bg-red-100 border-2 border-red-600 rounded">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="text-lg font-bold text-red-900 mb-2">REPORT RAGGING IMMEDIATELY</h3>
                <p className="text-gray-800 leading-relaxed mb-2">
                  If you are a victim or witness of ragging, report it immediately. Your identity will be kept confidential.
                </p>
                <p className="text-gray-800 font-semibold">
                  National Anti-Ragging Helpline: <span className="text-red-700">1800-180-5522</span> (24x7 Toll-Free)
                </p>
          ...
          <div className="mt-12 text-center">
            <p className="text-sm text-gray-500 mb-3">— Policy Published by —</p>
            <p className="text-xl font-bold text-gray-900 mb-1">Divine Group of Institutions</p>
            <p className="text-gray-600">Creating a Safe and Respectful Campus</p>
          </div>
        </article>
      </div>
    </div>
