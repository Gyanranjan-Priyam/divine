        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            {noticeItems.map((notice) => (
              <article
                key={notice.title}
                className="bg-white border border-gray-200 overflow-hidden hover:shadow-md"
              >
                <div className="h-32 bg-[#003366] flex items-center justify-center">
                  <Newspaper className="w-10 h-10 text-[#D4A853] opacity-50" />
                </div>
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-xs font-semibold text-[#003366] bg-[#e8edf2] px-2.5 py-1">
                      {notice.tag}
                    </span>
          ...
          <div className="text-center mt-10">
            <Link
              href="/notices"
              className="inline-flex items-center gap-2 border-2 border-[#003366] text-[#003366] font-semibold px-7 py-3 text-sm hover:bg-[#003366] hover:text-white"
            >
      ...
      <section className="bg-[#003366] py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            Join Divine Group of Institutions and be part of a community dedicated to 
            academic excellence and holistic development. Limited seats available.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              ...
              className="inline-flex items-center gap-2 border-2 border-white text-white font-semibold px-8 py-3 hover:bg-white hover:text-[#003366]"
            >
              Admission Process
            </Link>
          </div>
